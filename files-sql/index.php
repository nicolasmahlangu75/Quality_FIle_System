...
<div id="top">
   <?php if($allow_create_folder): ?>
	<form action="uploads" method="post" enctype="multipart/form-data" id="mkdir" />
...
<footer>user dashboard by <a href="https://github.com/Adolphus-design">Adolphus</a></footer>
</body>
</html>
